    ...
    <>
        ...
        <Card className="space-y-4">
          <div className="flex items-center gap-3">
            <div className="w-8 h-8 bg-lemon rounded-sm flex items-center justify-center flex-shrink-0">
              <svg className="w-4 h-4 text-surface-page" fill="none" stroke="currentColor" viewBox="0 0 24 24">
      ...
      {scannedCount > 0 && (
        <Card className="space-y-4">
          ...
          {payments.length === 0 ? (
            <div className="p-6 text-center bg-surface-page border border-dashed border-border rounded-sm">
            ...
            <div className="space-y-4">
              {payments.map((payment, index) => (
                <div key={index} className="p-4 border border-lemon/20 rounded-sm bg-lemon-muted space-y-4">
                  <div className="flex items-center gap-2">
                    <div className="w-8 h-8 bg-accent-green-muted rounded-sm flex items-center justify-center">
                      <svg className="w-5 h-5 text-accent-green" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                        <path strokeLinecap="round" strokeLinejoin="round" strokeWidth={2} d="M5 13l4 4L19 7" />
                      </svg>
                    </div>
                    <span className="text-xs uppercase tracking-wider font-medium text-primary">Payment Found!</span>
                  </div>
                  ...
                  <div className="p-3 bg-surface border border-dashed border-border rounded-sm">
                    <p className="text-xs text-secondary">
